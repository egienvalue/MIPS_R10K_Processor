# this is TCL template for module synthesis
...
#
set module rs
read_file -f sverilog [list "../../sys_defs.vh" "../../verilog/$module/ps.v" "../../verilog/$module/pe.v" "../../verilog/$module/rs1.v" "../../verilog/$module/rs.v"]
