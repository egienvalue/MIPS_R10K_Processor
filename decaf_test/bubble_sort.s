...
__L0:
	...
	# array = _tmp4
	  ...
	  stq		$r3, 0($r29)	# spill array from $r3 to $r29+0
	# _tmp5 = 0
...
__L1:
	...
	# *(_tmp11) = _tmp12
	  ...
	  ldq		$r3, -120($r15)	# fill _tmp11 to $r3 from $r15-120
	  stq		$r1, 0($r3)	# store with offset
	# _tmp13 = 1
